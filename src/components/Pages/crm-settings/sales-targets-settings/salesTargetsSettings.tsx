...
import { SalesTargetsSettingsListData } from "../../../../core/json/salesTargetsSettingsListData";
import { all_routes } from "@/router/all_routes";
import ModalSalesTargetsSettings from "./modal/modalSalesTargetsSettings";

const SalesTargetsSettingsComponent = () => {
  const route = all_routes;
  const data = SalesTargetsSettingsListData;
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a: any, b: any) => a.TargetName.length - b.TargetName.length,
    },
    {
      title: "Period",
      dataIndex: "Period",
  ...
  return (
    <>
        ...
        <div className="content pb-0">
          ...
          <ul className="nav nav-tabs nav-bordered mb-4" role="tablist">
            <li className="nav-item">
              <Link
                href={route.salesTargetsSettings}
            ...
            <li className="nav-item">
              <Link
                href={route.salesTargetsTeamsSettings}
      ...
      {/* ========================
			End Page Content
		========================= */}
      <ModalSalesTargetsSettings />
    </>
  );
};

export default SalesTargetsSettingsComponent;
