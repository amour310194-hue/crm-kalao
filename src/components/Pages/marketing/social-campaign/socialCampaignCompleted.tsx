...
import { SocialCampaignCompletedListData } from "../../../../core/json/socialCampaignCompletedListData";
import {
...
const SocialCampaignCompletedComponent = () => {
...
export default SocialCampaignCompletedComponent;
