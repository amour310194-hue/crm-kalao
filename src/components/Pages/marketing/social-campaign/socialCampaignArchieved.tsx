...
import { SocialCampaignArchievedListData } from "../../../../core/json/socialCampaignArchievedListData";
import {
...
const SocialCampaignArchievedComponent = () => {
...
export default SocialCampaignArchievedComponent;
