...
import { SmsCampaignCompletedListData } from "../../../../core/json/smsCampaignCompletedListData";
import {
...
const SmsCampaignCompletedComponent = () => {
...
export default SmsCampaignCompletedComponent;
