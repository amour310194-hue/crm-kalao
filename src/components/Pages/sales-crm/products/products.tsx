  ...
  const columns = [
    {
      ...
      render: (text: any) => (
        <h6 className="d-flex align-items-center fs-14 fw-normal mb-0">
          <Link href={route.productDetails}>{text}</Link>
        </h6>
      ),
    ...
    },
    {
      ...
      render: (text: any) => (
        <h6 className="fs-14 fw-medium mb-0">
          <Link href={route.productDetails} className="d-flex flex-column">
            {text}
          </Link>
        </h6>
      ),
    ...
    },
    {
      ...
      render: (text: string) => (
        <span
          className={`badge ${
            text === "Service" ? "bg-info" : "bg-secondary"
          }`}
        >
          {text}
        </span>
    ...
    },
    {
      title: "Unit Price",
      dataIndex: "UnitPrice",
      sorter: (a: any, b: any) => a.UnitPrice.length - b.UnitPrice.length,
    },
    {
      title: "Tax %",
      dataIndex: "Tax",
      ...
      render: () => (
        <div className="dropdown table-action">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            ...
            <Link className="dropdown-item" href={route.productDetails}>
