...
import {
  SalesTargetTeamListData,
  SalesTargetTeamFilterTeams,
} from "../../../../core/json/salesTargetTeamListData";
import { all_routes } from "@/router/all_routes";

const SalesTargetTeamComponent = () => {
  const route = all_routes;
  const data = SalesTargetTeamListData;
          ...
          <ul className="nav nav-tabs nav-bordered mb-4" role="tablist">
            <li className="nav-item">
              <Link
                ...
                className="nav-link border-3 bg-transparent"
              >
            ...
            <li className="nav-item">
              <Link
                href={route.salesTargetTeam}
                className="nav-link border-3 bg-transparent active"
              >
                          ...
                          <div className="filter-set-content">
                            ...
                            >
                              <div className="filter-content-list bg-light rounded border p-2 shadow mt-2">
                                ...
                                <ul className="mb-0">
                                  {SalesTargetTeamFilterTeams.map((team) => (
                                    <li className="mb-1" key={team.key}>
...
export default SalesTargetTeamComponent;
