...
export const SalesVelocityKpis = {
  velocity: { label: "Sales Velocity", value: "$29,800", deltaLabel: "16.1% vs last quarter", deltaDirection: "up" as const },
  openOpportunities: { label: "Open Opportunities", value: "53", deltaLabel: "10.4%", deltaDirection: "up" as const },
  avgDealValue: { label: "Avg. Deal Value", value: "$42,400", deltaLabel: "6.5%", deltaDirection: "up" as const },
...
export const VelocityComparisonData: VelocityComparisonRow[] = [
  { key: "1", Metric: "Sales velocity", ThisQuarter: "$29,800", LastQuarter: "$20,941", ChangeVsLastQuarter: 42, Target: "$41,786", ChangeVsTarget: -29 },
  { key: "2", Metric: "Opportunities", ThisQuarter: "53", LastQuarter: "48", ChangeVsLastQuarter: 10, Target: "60", ChangeVsTarget: -12 },
  { key: "3", Metric: "Avg. deal value", ThisQuarter: "$42,400", LastQuarter: "$39,800", ChangeVsLastQuarter: 7, Target: "$45,000", ChangeVsTarget: -6 },
...
export const VelocityByStageData: VelocityDimensionRow[] = [
  { key: "1", Dimension: "Qualification", Opportunities: 18, AvgDealValue: "$28,400", WinRate: "32%", SalesCycle: "12 days", VelocityPerDay: "$13,100", Link: all_routes.dealsGrid },
  { key: "2", Dimension: "Needs Analysis", Opportunities: 14, AvgDealValue: "$34,900", WinRate: "44%", SalesCycle: "15 days", VelocityPerDay: "$14,300", Link: all_routes.dealsGrid },
  { key: "3", Dimension: "Proposal Sent", Opportunities: 11, AvgDealValue: "$41,600", WinRate: "56%", SalesCycle: "19 days", VelocityPerDay: "$13,500", Link: all_routes.dealsGrid },
  { key: "4", Dimension: "Negotiation", Opportunities: 7, AvgDealValue: "$58,200", WinRate: "74%", SalesCycle: "14 days", VelocityPerDay: "$21,500", Link: all_routes.dealsGrid },
  { key: "5", Dimension: "Contract Review", Opportunities: 3, AvgDealValue: "$72,800", WinRate: "91%", SalesCycle: "9 days", VelocityPerDay: "$22,100", Link: all_routes.dealsGrid },
];

export const VelocityBySourceData: VelocityDimensionRow[] = [
  { key: "1", Dimension: "Referral", Opportunities: 9, AvgDealValue: "$54,700", WinRate: "79%", SalesCycle: "38 days", VelocityPerDay: "$10,200", Link: all_routes.dealsGrid },
  { key: "2", Dimension: "Webinar", Opportunities: 12, AvgDealValue: "$38,900", WinRate: "62%", SalesCycle: "44 days", VelocityPerDay: "$6,600", Link: all_routes.dealsGrid },
  { key: "3", Dimension: "Outbound", Opportunities: 16, AvgDealValue: "$49,200", WinRate: "57%", SalesCycle: "49 days", VelocityPerDay: "$9,200", Link: all_routes.dealsGrid },
  { key: "4", Dimension: "Trade Show", Opportunities: 9, AvgDealValue: "$42,600", WinRate: "52%", SalesCycle: "47 days", VelocityPerDay: "$4,200", Link: all_routes.dealsGrid },
  { key: "5", Dimension: "Paid Search", Opportunities: 7, AvgDealValue: "$27,400", WinRate: "30%", SalesCycle: "55 days", VelocityPerDay: "$1,000", Link: all_routes.dealsGrid },
];

export const VelocityByProductData: VelocityDimensionRow[] = [
  { key: "1", Dimension: "CRM Platform", Opportunities: 21, AvgDealValue: "$52,400", WinRate: "66%", SalesCycle: "45 days", VelocityPerDay: "$16,100", Link: all_routes.dealsGrid },
  { key: "2", Dimension: "Analytics Add-on", Opportunities: 13, AvgDealValue: "$28,900", WinRate: "63%", SalesCycle: "41 days", VelocityPerDay: "$5,800", Link: all_routes.dealsGrid },
  { key: "3", Dimension: "Support Plus", Opportunities: 11, AvgDealValue: "$18,600", WinRate: "58%", SalesCycle: "36 days", VelocityPerDay: "$3,300", Link: all_routes.dealsGrid },
  { key: "4", Dimension: "Migration Service", Opportunities: 8, AvgDealValue: "$34,100", WinRate: "48%", SalesCycle: "52 days", VelocityPerDay: "$2,500", Link: all_routes.dealsGrid },
];
