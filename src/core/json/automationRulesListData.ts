...
export const AutomationRulesListData: AutomationRuleData[] = [
  ...
  },
  {
    ...
    Status: "active",
    Link: "deals.html",
    Flow: ruleFlow("Deal Created", "Deal value > $100,000", "Send notification"),
  },
  {
    key: "3",
    RuleId: "R-203",
  ...
  },
  {
    ...
    Status: "error",
    Link: "invoices.html",
    Flow: ruleFlow("Invoice Overdue", "Amount > $5,000", "Send notification + add tag"),
  },
  {
    key: "7",
    RuleId: "R-207",
